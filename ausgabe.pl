...
ausgabeVorgaenge(Vorgaenge, VorgaengePred, VorgaengePredDanach) :-
	...
	textResources:getText(leerIstBekannt, IB),
...
ausgabeVorgaenge(Vorgaenge, VorgaengePred, VorgaengePredDanach) :-
	...
	string_concat(ES, WandelAnzString, Anweisung0),
 	textResources:getText(leerEinheiten, Eh),
...
ausgabeVorgaenge(Vorgaenge, VorgaengePred, VorgaengePredDanach) :-
	...
	textResources:getText(Produkt, ProduktString),
	textResources:getText(bitteReisenSieNachSystem, TxtBitteReisenSieNachSystem),
 	string_concat(TxtBitteReisenSieNachSystem, SystemNachString, Anweisung6),
 	textResources:getText(leerPlanet, Plan),
...
bildeOperation(Zeit, Operation, OperationString) :-
	...
	textResources:getText(leerEinHundertstel, EHstl),
