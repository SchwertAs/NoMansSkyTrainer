...
stoff(handelsWare, geborgenesFregattenModul, 95000).
stoff(handelsWare, lagerErweiterung, 95000).
...
stoff(basisBauEndStoff, byteBeatKabel, 0).
...
stoff(basisBauEndStoff, teleportKabel, 0).
...
stoff(kuriositaet, herzDerSonne, 10e00).
...
stoff(bauRezept, teleportKabelRezept, 0).
stoff(bauRezept, byteBeatKabelRezept, 0).
