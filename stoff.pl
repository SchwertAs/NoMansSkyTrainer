...
stoff(basisBauEndStoff, zuckendesEi, 0).
stoff(basisBauEndStoff, antiMaterieJetpackSpur, 0).
stoff(basisBauEndStoff, regenBogenJetpackSpur, 0).
stoff(basisBauEndStoff, roteJetpackSpur, 0).
stoff(basisBauEndStoff, grueneJetpackSpur, 0).
stoff(basisBauEndStoff, blaueJetpackSpur, 0).
stoff(basisBauEndStoff, ariadneGesicht, 0).
stoff(basisBauEndStoff, kronosGesicht, 0).
stoff(basisBauEndStoff, persesGesicht, 0).
stoff(basisBauEndStoff, heperosGesicht, 0).
stoff(basisBauEndStoff, seleneGesicht, 0).
stoff(basisBauEndStoff, tethysGesicht, 0).
stoff(basisBauEndStoff, eosGesicht, 0).
stoff(basisBauEndStoff, hyperionGesicht, 0).
stoff(basisBauEndStoff, heliosGesicht, 0).
stoff(basisBauEndStoff, aresGesicht, 0).
stoff(basisBauEndStoff, merkurGesicht, 0).
stoff(basisBauEndStoff, geminiGesicht, 0).
stoff(basisBauEndStoff, gepanzerteSchulterPlatten, 0).
stoff(basisBauEndStoff, gepanzerteGamaschen, 0).
stoff(basisBauEndStoff, gepanzerteExoHandschuhe, 0).
stoff(basisBauEndStoff, gepanzerteStiefel, 0).
stoff(basisBauEndStoff, erstGebrueteterKampfMaske, 0).
...
stoff(basisBauEndStoff, augeDerKorvaxHelm, 0).
stoff(basisBauEndStoff, taschenRealitaetsGenerator, 0).
stoff(basisBauEndStoff, abwesenderBlick, 0).
stoff(basisBauEndStoff, heroischePose, 0).
stoff(basisBauEndStoff, unglaeubigkeit, 0).
...
stoff(basisBauEndStoff, keinProblem, 0).
...
stoff(basisBauEndStoff, erstaunen, 0).
...
stoff(basisBauEndStoff, feiern, 0).
...
stoff(basisBauEndStoff, ha, 0).
stoff(basisBauEndStoff, lodernderOrbitHelm, 0).
...
stoff(basisBauEndStoff, totalVerbluefft, 0).
stoff(basisBauEndStoff, spaerlicherHorizontHelm, 0).
